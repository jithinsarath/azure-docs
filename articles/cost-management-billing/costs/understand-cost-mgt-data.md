...
- Managing tags requires contributor access to each resource or the [tag contributor](https://learn.microsoft.com/azure/role-based-access-control/built-in-roles#tag-contributor) RBAC role at an appropriate scope.
